...
public class AsteraVersionDetailPreferenceController extends BasePreferenceController {

    private static final String TAG = "AsteraVersionDialogCtrl";
    ...
    public AsteraVersionDetailPreferenceController(Context context, String key) {
        super(context, key);
    ...
    public boolean handlePreferenceTreeClick(Preference preference) {
        ...
        if (fullRomVersion) {
            ...
            preference.setSummary(SystemProperties.get(KEY_ASTERA_RELEASE_VERSION_PROP,
